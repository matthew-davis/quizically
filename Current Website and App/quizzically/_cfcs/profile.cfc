...
<CFCOMPONENT>
	...
	<CFFUNCTION NAME="profileProcess" ACCESS="public" RETURNTYPE="struct">
        ...
        <CFTRY>
			...
			<CFSET resultStruct.toastType = "#updatetype#" />
            <CFSET resultStruct.toastCode = 1 />
            <CFSET resultStruct.toastTitle = "Success" />
            <CFSET resultStruct.toastMessage = "Your profile has been updated!" />
            ...
            <CFCATCH>
                ...
                <CFSET resultStruct.toastMessage = "Sorry, there was an error editing your profile!" />
                <CFRETURN resultStruct />
