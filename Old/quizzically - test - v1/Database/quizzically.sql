...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=30020 ;
...
(30000, 'test@test.com', '5a105e8b9d40e1329780d62ea2265d8a', 'Wittin', 40013, 'Y', '2014-05-18 12:53:21', 0, 31, NULL, NULL),
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=60142 ;
...
CREATE TABLE IF NOT EXISTS `B_QUIZ` (
  ...
  KEY `LOCATION_ID` (`LOCATION_ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=90048 ;
...
CREATE TABLE IF NOT EXISTS `C_LOGIN` (
  ...
  KEY `USER_ID` (`USER_ID`),
  KEY `CLIENT_ID` (`CLIENT_ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=110223 ;
