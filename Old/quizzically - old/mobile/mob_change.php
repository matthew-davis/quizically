...
-->
	...
	<head>
		...
		<link rel="stylesheet" href="mob_login.css">
		<script type="text/javascript" charset="utf-8" src="jquery-2.0.3.min.js"></script>
		<script type="text/javascript" charset="utf-8" src="mob_change.js"></script>
	...
	<body id="web_change">
		...
		<div id="web_content_wrapper">
			<div id="web_logo_top">
				<img src="http://www.quizzically.co.uk/quizzically/mobile/quizzically_logo.png" width="100%" alt="quizzically logo" id="quizzically_logo" style="background-image:url('http://www.quizzically.co.uk/quizzically/mobile/background.png'); background-repeat:repeat;">			
			</div>
			<br><br>
