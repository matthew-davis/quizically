...
$mailer = "<div style='margin: 0 auto; width: 520px; padding: 12px; float: left;'>
			   <div>
		           <img src='http://www.quizzically.co.uk/quizzically/mobile/quizzically_logo.png' width='300px' alt='quizzically logo' style='background-image:url(\"http://www.quizzically.co.uk/quizzically/mobile/background.png\"); background-repeat:repeat; float: left;' />
				   <br><br>
			   </div>
			   <br><br><br>
		       Hi " . $name . ",
		       ...
		       <br><br>
		       <a href='http://www.quizzically.co.uk/quizzically/mobile/mob_change.php?forgot_key=" . $forgot_key . "'>http://www.quizzically.co.uk/quizzically/mobile/mob_change.php?forgot_key=" . $forgot_key . "</a>
		       <br><br>
