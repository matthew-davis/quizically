...
<CFCOMPONENT>
                ...
                <CFTRANSACTION>
					...
					<CFIF #additem3.RECORDCOUNT# EQ 0>
	                    ...
	                    <CFQUERY NAME="additem5" DATASOURCE="#THIS.dsn#">
	                        ...
	                        INSERT INTO data_participants (participant_UUID, player_UUID, quiz_UUID, participant_team, participant_accepted, participant_created, participant_score, participant_time)
	...
	<CFFUNCTION NAME="getPlayerScore" ACCESS="public" RETURNTYPE="query">
        ...
        <CFQUERY NAME="playerscore" DATASOURCE="#THIS.dsn#">
        	...
        	SELECT *,
				   CASE WHEN b.participant_team IS NULL AND c.player_lastname IS NULL THEN c.player_firstname
				   		WHEN b.participant_team IS NULL AND c.player_lastname IS NOT NULL THEN c.player_firstname & ' ' & c.player_lastname
				   		ELSE b.participant_team END AS participant_name

            	FROM sys_players a
						LEFT JOIN data_participants b ON a.player_UUID = b.player_UUID
						LEFT JOIN sys_players_details c ON a.player_details_UUID = c.player_details_UUID
