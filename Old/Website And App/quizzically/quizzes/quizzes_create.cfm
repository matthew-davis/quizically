...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <CFSCRIPT>
		...
		getcategories = dropdownsObj.getCategories();
	</CFSCRIPT>
      		...
      		<div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        ...
                        <form role="form" method="post" action="<CFOUTPUT>#request.baseurl#</CFOUTPUT>quizzes/quizzes_process.cfm" name="myform" id="myform">
