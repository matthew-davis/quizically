<CFCOMPONENT HINT="dynamic component">
	...
	<CFFUNCTION NAME="playerProcess" ACCESS="public" RETURNTYPE="struct">
		...
		<CFIF #THIS.action# is "add">
            ...
            <CFIF playercheck.RECORDCOUNT GT 0>
                ...
                <CFSET resultStruct.statusMessage = "The Player" & " " & "#THIS.player_email#" & " " & "has already been created!" />
            ...
            <CFELSE>
                 ...
                 <CFTRY> 
                    ...
                    <CFLOCK TIMEOUT="20">
                        ...
                        <CFTRANSACTION>
                            ...
                            <CFQUERY NAME="additem1" DATASOURCE="#THIS.dsn#">
                                ...
                                INSERT INTO players_details (player_details_UUID, player_firstname, player_lastname, player_birthday, player_gender, player_email, player_occupation, location_UUID, player_quizzes, added_by, added_date)
                                    VALUES	(
                    ...
                    <CFSET resultStruct.statusMessage = "#THIS.player_email#" & " " & "has been created!" />
                    <CFRETURN RESULTSTRUCT />
                    ...
                    <CFCATCH>
                       ...
                       <CFSET resultStruct.statusCode = -1 />
                       <CFSET resultStruct.statusClass = "Error" />
                       <CFSET resultStruct.statusMessage = "Sorry, there was an error creating" & " " & "#THIS.player_email#" & "!" />
                       <CFRETURN RESULTSTRUCT />
		...
		<CFIF #THIS.action# is "edit">
            ...
            <CFTRY>
                ...
                <CFSET resultStruct.statusCode = 1 />
                <CFSET resultStruct.statusClass = "Success" />
                <CFSET resultStruct.statusMessage = "#THIS.player_email#" & " " & "has been edited!" />
                <CFRETURN resultStruct />
                ...
                <CFCATCH>
                   ...
                   <CFSET resultStruct.statusCode = -1 />
                   <CFSET resultStruct.statusClass = "Error" />
                   <CFSET resultStruct.statusMessage = "Sorry, there was an error editing" & " " & "#THIS.player_email#" & "!" />
                   <CFRETURN resultStruct />
		...
		<CFIF #THIS.action# is "delete">
    		...
    		<CFTRY>
				...
				<CFSET resultStruct.statusCode = 1 />
                <CFSET resultStruct.statusClass = "Success" />
                <CFSET resultStruct.statusMessage = "#deleteitem1.player_email#" & " " & "has been deleted!" />
                <CFRETURN resultStruct />
        		...
        		<CFCATCH>
				   ...
				   <CFSET resultStruct.statusCode = -1 />
                   <CFSET resultStruct.statusClass = "Error" />
                   <CFSET resultStruct.statusMessage = "Sorry, there was an error deleting" & " " & "#deleteitem1.player_email#" & "!" />
                   <CFRETURN resultStruct />
		...
		<CFIF #THIS.action# is "undelete">
    		...
    		<CFTRY>
				...
				<CFSET resultStruct.statusCode = 1 />
                <CFSET resultStruct.statusClass = "Success" />
                <CFSET resultStruct.statusMessage = "#undeleteitem1.player_email#" & " " & "has been un-deleted!" />
                <CFRETURN resultStruct />
        		...
        		<CFCATCH>
				   ...
				   <CFSET resultStruct.statusCode = -1 />
                   <CFSET resultStruct.statusClass = "Error" />
                   <CFSET resultStruct.statusMessage = "Sorry, there was an error un-deleting" & " " & "#undeleteitem1.player_email#" & "!" />
                   <CFRETURN resultStruct />
	...
	<CFFUNCTION NAME="getPlayerDetails" ACCESS="public" RETURNTYPE="query">
		...
		<CFQUERY NAME="playerdetails" DATASOURCE="#THIS.dsn#">
			SELECT *,
            	...
            	FROM players a
                		INNER JOIN players_details b ON a.player_details_UUID = b.player_details_UUID
                		LEFT JOIN (SELECT player_UUID, MAX(login_date) AS last_login FROM logins GROUP BY player_UUID) c ON a.player_UUID = c.player_UUID
    ...
    <!--- Player Numbers --->
	<CFFUNCTION NAME="getPlayersNumber" ACCESS="public" RETURNTYPE="query">
			
        <CFQUERY NAME="playersnumber" DATASOURCE="#THIS.dsn#">
        
        	SELECT IFNULL(COUNT(*), 0) AS playerscount
		...
		<CFRETURN playersnumber />
	
	</CFFUNCTION>
	<!--- End Player Numbers ---> 
    
    
    <!--- Deleted Player Numbers --->
	<CFFUNCTION NAME="getDeletedPlayersNumber" ACCESS="public" RETURNTYPE="query">
			
        <CFQUERY NAME="playersnumber" DATASOURCE="#THIS.dsn#">
        
        	SELECT IFNULL(COUNT(*), 0) AS deletedplayerscount
