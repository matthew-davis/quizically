...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  	...
  	<head>
        ...
        <CFSET menupage = 'managdeletedeplayers' />
      		...
      		<div class="content-wrapper"> 
            	...
            	<section class="content-header">
                  	<h1>
                        ...
                        &nbsp;&nbsp;
                        <span class="label label-danger"><CFOUTPUT>#deletedplayersnumber.deletedplayerscount#</CFOUTPUT></span> 
                    </h1>
                	<ol class="breadcrumb">
                                	...
                                	<table id="myTable" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	<form style="display: inline;" method="post" action="./players.cfm?player_details_UUID=#player_details_UUID#&action=undelete">
