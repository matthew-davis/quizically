...
--
-- Host: localhost
-- Generation Time: Aug 25, 2014 at 02:19 AM
...
(1, 'quizzically', 'B_QUIZ', 'NO_OF_ROUNDS', '', '', '_', ''),
(2, 'quizzically', 'B_GAME', 'ROUNDS_LEFT', '', '', '_', '');
...
('root', '[{"db":"quizzically","table":"B_GAME"},{"db":"quizzically","table":"B_QUIZ"},{"db":"quizzically","table":"A_CLIENT"},{"db":"quizzically","table":"C_LOGIN"},{"db":"quizzically","table":"A_USER"},{"db":"quizzically","table":"D_LOCATION"},{"db":"quizzically","table":"B_QUESTION"},{"db":"quizzically","table":"D_CATEGORY"},{"db":"quizzically","table":"B_PARTICIPANT"},{"db":"quizzically","table":"DUAL"}]');
...
(30000, 'test@test.com', '5a105e8b9d40e1329780d62ea2265d8a', 'Wittin', 40013, 'Y', '2014-05-18 12:53:21', 0, 51, NULL, NULL),
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=60265 ;
...
CREATE TABLE IF NOT EXISTS `B_QUIZ` (
  ...
  KEY `LOCATION_ID` (`LOCATION_ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=90104 ;
...
CREATE TABLE IF NOT EXISTS `C_LOGIN` (
  ...
  KEY `USER_ID` (`USER_ID`),
  KEY `CLIENT_ID` (`CLIENT_ID`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=110286 ;
